...
<form action="/vacation/vacationDelete" method="post" id="deleteForm">
	<sec:csrfInput/>
...
$(function(){
	...
	$("#insertBtn").click(function(){
		...
		var vacSdate = $("#vacSdate").val();
		var vacEdate = $("#vacEdate").val();
		if(vacSdate > vacEdate){
			alert("끝난일자는 시작일자보다 늦을 수 없습니다.");
			return false;
		}
		if(vacContent == null || vacContent == ""){
			alert("내용을 입력해 주세요!");
			return false;
		}
