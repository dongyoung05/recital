                            ...
                            <div class="card-body">
                                <div class="card-tools">
                                    <form class="input-group input-group-sm mb-3"
                                        action="${pageContext.request.contextPath}/professor/freeList"
                                ...
                                <form id="deleteMultipleForm" action="${pageContext.request.contextPath}/admin/freeDeleteMultiple" method="post">
                                            ...
                                            <tbody>
                                                <c:forEach var="board" items="${freeboardList}" varStatus="status">
                                                    <tr>
                                                        ...
                                                        <td>${board.rnum}</td>
                                                        <td><a href="${pageContext.request.contextPath}/professor/freeDetail/${board.freeNo}"><c:out value="${board.freeTitle}" /></a></td>
                                    ...
                                    <div class="text-right mt-2">
                                        <a href="${pageContext.request.contextPath}/professor/freeWrite" class="btn btn-primary">새 글 등록</a>
