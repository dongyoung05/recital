        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card mb-4 bg-white">
                    ...
                    <div class="card-body">
                        <form name="frm" action="/professor/freeWrite" method="post" onsubmit="event.preventDefault(); insertAlert();">
                            <sec:csrfInput/>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="${pageContext.request.contextPath}/professor/freeList" class="btn btn-secondary">취소</a>
                            </div>
                        </form>
                    </div>
                </div>
