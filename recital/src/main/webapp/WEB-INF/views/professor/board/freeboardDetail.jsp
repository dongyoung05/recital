                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="flex-container">
                                <a href="${pageContext.request.contextPath}/professor/freeList" class="btn btn-primary">목록으로</a>
                            ...
                            <sec:authorize access="hasRole('ROLE_STUDENT')">
                                ...
                                <c:if test="${freeboard.userNo == userNo}">
                                    <span id="spnGen">
                                        ...
                                        <form id="deleteForm" action="${pageContext.request.contextPath}/professor/freeDelete" method="post">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <c:forEach var="comment" items="${commentList}">
                                <div class="border p-2 mb-2">
                                    ...
                                    <div id="commentForm-${comment.fcNo}" style="display: none;">
                                        <form action="${pageContext.request.contextPath}/professor/freeCommentUpdate" method="post">
                                    ...
                                    <form id="deleteForm-${comment.fcNo}" action="${pageContext.request.contextPath}/professor/freeCommentDelete" method="post" style="display: inline;">
                                        <input type="hidden" name="fcNo" value="${comment.fcNo}">
                                        <input type="hidden" name="freeNo" value="${freeboard.freeNo}">
                            ...
                            <form action="${pageContext.request.contextPath}/professor/freeCommentInsert" method="post">
                                <input type="hidden" name="freeNo" value="${freeboard.freeNo}">
                                <div class="form-group mt-2">
                    ...
                    <div id="reportModal" class="modal">
                        <div class="modal-content">
                            ...
                            <form id="reportSubmitForm" action="${pageContext.request.contextPath}/professor/report" method="post">
