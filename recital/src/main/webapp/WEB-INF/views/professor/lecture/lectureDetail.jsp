		...
		<div class="container-xxl flex-grow-1 container-p-y">
			...
			<div class="row">
								...
								<tbody class="table-border-bottom-0">
									<c:choose>
										<c:when test="${empty lectureNoticeList }">
											<tr>
												<td colspan="2">조회하신 게시글이 없습니다.</td>
											</tr>
										</c:when>
										 <c:otherwise>
				...
				<div class="col-lg-6 mb-4">
					<div class="card">
						<div style="display: flex; justify-content: space-between;">
							<h5 class="card-header"style="width: 130px;"><a href="/professor/selectAssignmentList.do?lecNo=${lecNo }">과제목록</a></h5>
							<a href="/professor/selectAssignmentList.do?lecNo=${lecNo }" class="btn btn-outline-primary" style="width: 90px; height: 35px; margin: 20px;">더보기</a>
						</div>
						<div class="table-responsive text-nowrap">
							<table class="table table-hover">
								<thead>
									...
									<c:choose>
										<c:when test="${empty assignmentList }">
		                                 ...
		                                 <c:forEach items="${assignmentList }" var="assignList">
		                                    <tr>
		                                       <td>
			                                       <a href="/professor/selectAssignmentDetail.do?lecNo=${lecNo}&assNo=${assignList.assNo }">
				                                       ${assignList.assTitle }
			                                       </a>
		                                       </td>
				...
				<div class="col-lg-6 mb-4">
					<div class="card">
						<div style="display: flex; justify-content: space-between;">
							<h5 class="card-header"  style="width: 130px;"><a href="/exam/examList?lecNo=${lecNo }">시험목록</a></h5>
				...
				<div class="col-lg-6 mb-4">
					<div class="card">
						<div style="display: flex; justify-content: space-between;">
							...
							<a href="/professor/selectLectureDataList.do?lecNo=${lecNo }" class="btn btn-outline-primary" style="width: 90px; height: 35px; margin: 20px;">더보기</a>
						</div>
						<div class="table-responsive text-nowrap">
							<table class="table table-hover">
								<thead>
									...
									<c:choose>
										<c:when test="${empty lecDataList }">
		                                 ...
		                                 <c:forEach items="${lecDataList }" var="data">
		                                    <tr>
		                                       <td>
			                                       <a href="/professor/selectLectureDataDetail.do?lecDataNo=${data.LEC_DATA_NO }&lecNo=${lecNo}">
				                                       ${data.LEC_DATA_TITLE }
			                                       </a>
		                                       </td>
