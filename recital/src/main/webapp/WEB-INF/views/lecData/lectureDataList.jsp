...
<body>
	...
	<div class="content-wrapper">
		<div class="container-xxl flex-grow-1 container-p-y">
			...
			<h2 class="fw-bold py-3 mb-4">홈 > 강의자료실</h2>
			<hr>
			<!-- Hoverable Table rows -->
			<div class="card">
				<c:if test="${prc.user.comDetUNo eq 'U0102'}">
					 <div class="demo-inline-spacing">
	                        <button type="button" class="btn btn-primary" id="insertBtn">자료등록</button>
	                 </div>
                </c:if> 
								...
								<c:otherwise>
									<c:forEach items="${pagingVO.dataList }" var="lectureData">
										<tr>
											...
											<td><a href="/lectureData/selectLectureDataDetail.do?lecDataNo=${lectureData.lecDataNo }&lecNo=${lecNo}">
