...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4" style="font-weight:bold; padding-left:20px;">맛집 게시글</h4>
    <div class="row">
        <div class="col-xl-12">
            <div class="card mb-4 bg-white">
                ...
                <div class="card-footer">
                    <a href="${pageContext.request.contextPath}/admin/foodList" class="btn btn-secondary float-left">목록으로</a>
