	...
	<div class="row">
		<div class="col-sm-4">
			<div class="card mb-4">
				<div class="card-header d-flex align-items-center justify-content-between">
					 <img class="col-sm-12" src="${pageContext.request.contextPath }${proVO.proImg}" id="thumImg" alt="프로필이미지" style="height: 400px;">
				</div>
				<div class="card-body">
					<div class="row mb-3">					
						<table class="col-sm-11 table table-borderless">
							<tbody>
								<tr>
									...
									<td class="py-3"><p class="mb-0">${proVO.proName }</p></td>
								</tr>
								<tr>	
									<td class="text-end"><small class="text-light fw-semibold" >아이디</small></td>
									<td class="py-3"><p class="mb-0">${proVO.proNo }</p></td>
								</tr>
								<tr>	
									<td class="text-end"><small class="text-light fw-semibold">학과</small></td>
									<td class="py-3"><p class="mb-0">${proVO.deptName }</p></td>
								</tr>
								
								<tr>	
									<td class="text-end"><small class="text-light fw-semibold">전화번호</small></td>
									<td class="py-3"><p class="mb-0">${proVO.proPhone }</p></td>
								</tr>
								<tr>	
									<td class="text-end"><small class="text-light fw-semibold">주소</small></td>
									<td class="py-3"><p class="mb-0">${proVO.proAdd1 } ${proVO.proAdd2 }</p></td>
								</tr>
								<tr>	
									<td class="text-end"><small class="text-light fw-semibold">이메일</small></td>
									<td class="py-3"><p class="mb-0">${proVO.proEmail }</p></td>
								</tr>
							</tbody>
						</table>
					</div>
		...
		<div class="col-sm-8">
           ...
           <div class="card">
             ...
             <hr class="my-0">
             <div class="card-body">
                    <form action="/admin/proUpdate" method="post" enctype="multipart/form-data" id="formData">
                      <sec:csrfInput/>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name"><font size="3">프로필사진</font></label>
                          <div class="col-sm-10">
                            <input type="file" class="form-control" name="proFile" id="imgFile"/>
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name"><font size="3">아이디</font></label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="proNo" id="proId" readonly="readonly" value="${proVO.proNo }" />
                          </div>
...
<!--                           </div> -->
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company"><font size="3">직위</font></label>
                          <div class="col-sm-10">
                          
                           <select name="comDetPNo" class="form-select">
                           		
                           		<c:forEach items="${proP }" var="proPcode">
                           			<option value="${proPcode.comDetNo }" <c:if test="${proVO.deptNo eq proPcode.comDetNo }">selected</c:if>>${proPcode.comDetName }</option>
                           		</c:forEach>
                           </select>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                           ...
                           <select name="deptNo" class="form-select">
                           		...
                           		<option value="${dept.deptNo }" <c:if test="${proVO.deptNo eq dept.deptNo }">selected</c:if>>${dept.deptName }</option>
                           		</c:forEach>
                           </select>
                          </div>
                        </div>
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <input
                                ...
                                class="form-control"
                                name="proEmail" value="${proVO.proEmail }"
                              />
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              name="proPhone" value="${proVO.proPhone }"
                            /> 
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-7">
                            <input
                              ...
                              class="form-control"     
                              type="text"
                              name="proPostcode" value="${proVO.proPostcode }"
                            ></input>
                          </div>
                          <div class="col-sm-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              class="form-control"
                              type="text"
                               name="proAdd1" value="${proVO.proAdd1 }"
                            ></input>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              class="form-control"        
                              type="text"
                              name="proAdd2" value="${proVO.proAdd2 }"
                            ></input>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <select name=comDetMNo class="form-select" id="deptNo">
                            	<c:forEach items="${proMCode }" var="MCode">
                            		<option value="${MCode.comDetNo }" <c:if test="${proVO.comDetMNo eq MCode.comDetNo}">selected</c:if>>${MCode.comDetName }</option>
                            	</c:forEach>
                            </select>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="proAccount"><font size="3">계좌번호</font></label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="proAccount" name="proAccount" value="${proVO.proAccount }">
                          </div>
                        </div>
                      ...
                      <form id="deleteForm" method="post" action="/admin/proDelete">
                      <sec:csrfInput/>
...
$(function(){
	...
	// 생각해보니 교수든 뭐든 유저들 아이디값은 기본키라 바뀌면??? update문을 어케쓰지??
// 	idCheck.on("click", function(){
// 		var proId = $("#proId").val();
		
// 		var engNum =  /^[a-zA-Z0-9]*$/;
		
// 		if(!engNum.test(proId)){
...
// 				$("#error").html("사용이 가능한 아이디입니다.").css("color", "green");
// 				flag = true;
// 			},
// 			error : function(xhr){
// 				$("#error").html("이미 사용중인 아이디 입니다.").css("color", "red");
// 				flag = false;
// 			}
// 		});
