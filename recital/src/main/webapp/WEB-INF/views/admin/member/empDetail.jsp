	...
	<div class="row">
		<div class="col-sm-4">
			<div class="card mb-4">
				<div class="card-header d-flex align-items-center justify-content-between">
					 <img class="col-sm-12" src="${pageContext.request.contextPath }${empVO.empImg}" id="thumImg" alt="프로필이미지" style="height: 400px;">
				</div>
				<div class="card-body">
					<div class="row mb-3">					
						<table class="col-sm-11 table table-borderless">
							<tbody>
								<tr>
									...
									<td class="py-3"><p class="mb-0">${empVO.empName }</p></td>
								</tr>
								<tr>	
									<td class="text-end"><small class="text-light fw-semibold" >아이디</small></td>
									<td class="py-3"><p class="mb-0">${empVO.empNo }</p></td>
								</tr>
								<tr>	
									<td class="text-end"><small class="text-light fw-semibold">부서</small></td>
									<td class="py-3"><p class="mb-0">${empVO.comDetDNo }</p></td>
								</tr>
								
								<tr>	
									<td class="text-end"><small class="text-light fw-semibold">전화번호</small></td>
									<td class="py-3"><p class="mb-0">${empVO.empPhone }</p></td>
								</tr>
								<tr>	
									<td class="text-end"><small class="text-light fw-semibold">주소</small></td>
									<td class="py-3"><p class="mb-0">${empVO.empAdd1 } ${empVO.empAdd2 }</p></td>
								</tr>
								<tr>	
									<td class="text-end"><small class="text-light fw-semibold">이메일</small></td>
									<td class="py-3"><p class="mb-0">${empVO.empEmail }</p></td>
								</tr>
							</tbody>
						</table>
					</div>
		...
		<div class="col-sm-8">
           ...
           <div class="card">
             ...
             <hr class="my-0">
             <div class="card-body">
                    <form action="/admin/empUpdate" method="post" enctype="multipart/form-data" id="formData">
                      <sec:csrfInput/>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name"><font size="3">프로필사진</font></label>
                          <div class="col-sm-10">
                            <input type="file" class="form-control" name="empFile" id="imgFile"/>
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name"><font size="3">아이디</font></label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="empNo" id="empId" readonly="readonly" value="${empVO.empNo }" />
                          </div>
...
<!--                           </div> -->
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company"><font size="3">부서</font></label>
                          <div class="col-sm-10">
                          
                          
                           <select name="comDetDNo" class="form-select">
                           		<option value="D0101" <c:if test="${empVO.comDetDNo eq 'D0101' }">selected</c:if>>행정과</option>
                           		<option value="D0102" <c:if test="${empVO.comDetDNo eq 'D0102' }">selected</c:if>>인사과</option>                           		
                           </select>
                          </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-7">
                            <input
                              ...
                              class="form-control"     
                              type="text"
                              name="empPostcode" value="${empVO.empPostcode }"
                            ></input>
                          </div>
                          <div class="col-sm-3">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="deptNo"><font size="3">재적상태</font></label>
                          <div class="col-sm-10">
                            <select name=comDetMNo class="form-select" id="deptNo">
                            	<c:forEach items="${empMCode }" var="MCode">
                            		<option value="${MCode.comDetNo }" <c:if test="${empVO.comDetMNo eq MCode.comDetNo}">selected</c:if>>${MCode.comDetName }</option>
                            	</c:forEach>
                            </select>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="empAccount"><font size="3">계좌번호</font></label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="empAccount" name="empAccount" value="${empVO.empAccount }">
                          </div>
                        </div>
                      ...
                      <form id="deleteForm" method="post" action="/admin/empDelete">
                      <sec:csrfInput/>
