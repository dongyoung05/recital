	...
	<div class="card">
		...
		<div class="card-body">
			<div class="row">
				<div class="col-6 p-4">
					<div class="row mb-3">	
						<label class="col-2 col-form-label ti" for="conTitle"><font size="4">상담명</font></label>						
						<label class="col-10 col-form-label" for="conTitle"><font size="4">${consulting.conTitle }</font></label>			
					</div>
					<div class="row mb-3">	
						<label class="col-2 col-form-label ti" for="proName"><font size="4">교수</font></label>						
						<label class="col-10 col-form-label" for="proName"><font size="4">${consulting.proName }</font></label>			
					</div>
					<div class="row mb-3">
						<label class="col-2 col-form-label ti"><font size="4">교수아이디</font></label>
						<label class="col-10 col-form-label"><font size="4">${consulting.proNo }</font></label>
					</div>
					<div class="row mb-3">	
						<label class="col-2 col-form-label ti" for="stuName"><font size="4">학생</font></label>						
						<label class="col-10 col-form-label" for="stuName"><font size="4">${consulting.stuName }</font></label>			
					</div>
					<div class="row mb-3">
						<label class="col-2 col-form-label ti"><font size="4">학생아이디</font></label>
						<label class="col-10 col-form-label"><font size="4">${consulting.stuNo }</font></label>
					</div>
					<div class="row mb-3">	
						<label class="col-2 col-form-label ti" for="comDetNNo"><font size="4">상담구분</font></label>						
					...
					<div class="row mb-3">	
						<label class="col-sm-2 col-form-label ti" for="comDetSNo"><font size="4">진행상태</font></label>						
					...
					<div class="row mb-3">	
						<label class="col-sm-2 col-form-label ti" for="conOnoff"><font size="4">대면여부</font></label>						
				...
				<div class="col-6 p-4">	
					...
					<div class="row mb-3">	
						<label class="col-sm-2 col-form-label ti" for="conContent"><font size="4">내용</font></label>						
						<textarea rows="7" class="form-control" readonly="readonly">${consulting.conContent }</textarea>			
					</div>
<%-- 					<c:if test="${consulting.comDetSNo eq 'S0101' }"> --%>
						<div class="row mb-3">
							<label class="col-2 col-form-label ti" for="conResult"><font size="4">상담결과</font></label>
							<textarea rows="7" class="form-control" readonly="readonly">${consulting.conResult }</textarea>
						</div>
<%-- 					</c:if>	 --%>
					<div class="mb-3">
						<div class="card-footer" align="right">						
							<a  class="btn btn-primary" id="listBtn" href="/admin/consultingMain">목록</a>
