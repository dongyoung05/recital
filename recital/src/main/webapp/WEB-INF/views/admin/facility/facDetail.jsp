		...
		<div class="col-xl-12">
			<div class="card mb-4 bg-white">
				...
				<div class="col-11 text-center" style="height:300px;">
					<c:if test="${not empty facility.facImg  }">
						<img alt="이미지삽입" src="${pageContext.request.contextPath }${facility.facImg}" id="thumImg" style="height:280px;">
					</c:if>
					<c:if test="${empty facility.facImg }">						
				...
				<div class="card-body">
						<form action="/admin/facUpdate" method="post" id="formData" enctype="multipart/form-data">
						<sec:csrfInput/>
						...
						<div class="row mb-3">
							...
							<div class="col-sm-10">
								<div class="form-controller">
									<select name="facTypeNo" class="form-control">										
										...
										<option value="3" <c:if test="${facility.facTypeNo eq '4' }">selected</c:if>>사무실</option>										
									</select>
								</div>
								<input type="hidden" class="form-control" name="facNo" id="facNo" 
									value="${facility.facNo }" readonly="readonly">
							</div>
