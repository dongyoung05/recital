        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card mb-4 bg-white">
                    ...
                    <hr class="my-0">
                    <div class="card-body">
                        <form id="foodForm" action="${pageContext.request.contextPath}/student/foodInsert" method="post">
                            <sec:csrfInput />
                    ...
                    <div class="card-footer">
                        ...
                        <a href="${pageContext.request.contextPath}/student/foodList" class="btn btn-secondary">취소</a>
                    </div>
                </div>
            </div>
        </div>
