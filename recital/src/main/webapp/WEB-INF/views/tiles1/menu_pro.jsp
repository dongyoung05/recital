 ...
 <!-- Menu -->
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
             ...
             <!-- 로고눌렀을대 링크 -->
            <a href="/student/test_edu" class="app-brand-link">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="/professor/selectStudentList.do?lecNo=${param.lecNo}" class="menu-link" target="_blank">
                ...
                <li class="menu-item">
                  <a href="/professor/selectAssignmentList.do?lecNo=${param.lecNo}" class="menu-link" target="_blank">
...
<!--             </li> -->
              ...
              <ul class="menu-sub">                
                <li class="menu-item">
                  <a href="extended-ui-text-divider.html" class="menu-link">
                    <div data-i18n="Text Divider">신청내역조회</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="extended-ui-text-divider.html" class="menu-link">
                    <div data-i18n="Text Divider">휴가신청</div>
                  </a>
                </li>
              </ul>
            </li>
         ...
         <!-- 지도학생 -->
            <li class="menu-item">
              <a href="icons-boxicons.html" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-crown"></i>
                <div data-i18n="Boxicons">지도학생</div>
              </a>
              <ul class="menu-sub">
                 <li class="menu-item">
                    <a href="#" class="menu-link">
