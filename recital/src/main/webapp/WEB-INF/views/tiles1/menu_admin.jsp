 ...
 <!-- Menu -->
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
          	...
          	<!-- 로고눌렀을대 링크 -->
            <a href="/admin/test" class="app-brand-link">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link">
                <i class="menu-icon tf-icons bx bx-u   ser me-2"></i>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/subjectList" class="menu-link">
                    <div data-i18n="Basic">과목목록</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/admin/subjectInsertForm" class="menu-link">
                    <div data-i18n="Basic">과목등록</div>
                  </a>
                </li>                                
              </ul>                         
            </li>
            ...
            <li class="menu-item">
              <a href="icons-boxicons.html" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-crown"></i>
                <div data-i18n="Boxicons">증명서발급관리</div>
              </a>
              <ul class="menu-sub">
              	<li class="menu-item">
            ...
            <li class="menu-item">
              <a href="icons-boxicons.html" class="menu-link">
                <i class="menu-icon tf-icons bx bx-crown"></i>
                <div data-i18n="Boxicons">학점관리</div>
              </a>
            </li> 
			<!-- 봉사관리 -->
            <li class="menu-item">
